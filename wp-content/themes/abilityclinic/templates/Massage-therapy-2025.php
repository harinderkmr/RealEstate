<?php
/**
 * Template Name: Massage Therapy 2025
 */
 get_header();
?>
<!-- Page Title -->
...
<script type="application/ld+json">
{
    ...
    "mainEntity": [{
        "@type": "Question",
        "name": "What is massage therapy, and how does it work?",
        "acceptedAnswer": {
            "@type": "Answer",
            "text": "Massage is a form of manual manipulation in which a therapist kneads muscles, connective tissue, ligaments, tendons, and skin to reduce pain and muscle tightness."
        }
    }, {
        "@type": "Question",
        "name": "What are the different types of massage therapy you offer?",
        "acceptedAnswer": {
            "@type": "Answer",
            "text": "We offer the following types of massage therapy: deep tissue, lymphatic, sports, Swedish, prenatal, and hot stone massage."
        }
    }, {
        "@type": "Question",
        "name": "How do I know which type of massage is best for me?",
        "acceptedAnswer": {
            "@type": "Answer",
            "text": "Book an appointment with us. During our consultation, we can determine what type of massage is best for you."
        }
    }, {
        "@type": "Question",
        "name": "Do I need a doctor's referral for massage therapy?",
        "acceptedAnswer": {
            "@type": "Answer",
            "text": "No, you do not need a doctor’s referral for massage therapy."
        }
    }, {
        "@type": "Question",
        "name": "What should I do to prepare for my massage session?",
        "acceptedAnswer": {
            "@type": "Answer",
            "text": "Eat at least once before the session, drink enough water to ensure you stay hydrated during and after the session, wear comfortable clothes that you can take off quickly, and be open."
        }
    }, {
        "@type": "Question",
        "name": "Can I eat before my massage appointment?",
        "acceptedAnswer": {
            "@type": "Answer",
            "text": "Yes, you can. But ensure you eat light food."
        }
    }, {
        "@type": "Question",
        "name": "What can I expect during my first massage therapy session?",
        "acceptedAnswer": {
            "@type": "Answer",
            "text": "Well, you must be open to rubbing and kneading. The therapist may start with gentle strokes and kneading. Just be open to communicating with the therapist as the session progresses."
        }
    }, {
        "@type": "Question",
        "name": "How long do the effects of a massage last?",
        "acceptedAnswer": {
            "@type": "Answer",
            "text": "For stress and anxiety management, you start noticing changes almost immediately or after 24 hours. Your body will feel relaxed, and your mind will be calm."
        }
    }, {
        "@type": "Question",
        "name": "Are there any side effects after a massage?",
        "acceptedAnswer": {
            "@type": "Answer",
            "text": "Yes. Some people may experience muscle soreness after the session. This is entirely normal and should improve quickly."
        }
    }, {
        "@type": "Question",
        "name": "How soon can I book my next massage session?",
        "acceptedAnswer": {
            "@type": "Answer",
            "text": "You can book your next session as soon as possible. Reach out to us today."
        }
    }]
}
</script>
...
if ( $hero_group ) : 
?>
<section class="dexa-hero therapy-hero"
    ...
    <div class="container">
        <div class="dexa-hero-text text-white">
...
<section class="dexa-body-composition">
    ...
    <div class="bgblue py-4 text-center">
        <h2 class="fs-2 lh-1 mb-0 text-white">
            <?= get_sub_field('condition_heading'); ?>
        </h2>
    </div>
...
<section class="pad-scroll sec small-container pb-0 pt-0" id="<?php echo get_sub_field('condition_id'); ?>">
    ...
    <div class="bgblue py-4 text-center">
        ...
        <h2 class="fs-2 lh-1 mb-0 text-white">
            <?php echo get_sub_field('condition_type'); ?>
        </h2>
    ...
    <div class="container container-sm container-xs mb-2">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-6 col-md-4  align-items-center d-flex flex-column justify-content-start mt-5">
                ...
                <div class="text-cta-wrap">
                    ...
                    <h3>
                        <?php echo get_sub_field('condition_name'); ?>
                    </h3>
...
<div class="our-services bg-radius-section">
    <div class="container">
        <div class="head">
            <h2>
                <?= get_sub_field('technique_heading'); ?>
            </h2>
        </div>
...
<div class="care-rehabilitation choose-us">
    <div class="container">

        <div class="head">
            <h2>
                <?= get_sub_field('group_heading'); ?>
            </h2>
            <p>
...
<section class="dexa-hero our-clinic"
    ...
    <div class="hero-slider-wrap">
        ...
        <div class="container">
            <div class="head">
                <h2>
                    <?= get_sub_field('clinic_title'); ?>
                </h2>
                <p>
                    <?= get_sub_field('clinic_description'); ?>
                </p>
            </div>
...
@media only screen and (max-width: 768px) {
    .card-stack-wrapper {
        display: block;
        /* Show card-stack-wrapper on mobile */
    }

    .foo-gallery {
        display: none;
        /* Hide foo-gallery on mobile */
    }
}
...
@media only screen and (min-width: 769px) {
    .card-stack-wrapper {
        ...
        /* Hide card-stack-wrapper on larger screens */
    }

    .foo-gallery {
        display: block;
        /* Show foo-gallery on larger screens */
    }
}
        ...
        cards.forEach((card, index) => {
            ...
            if (offset === 0) {
                ...
                card.style.transform =
                    `translateX(${offset * 30}px) scale(${1 - offset * 0.1}) rotate(${offset * 3}deg)`;
